...
export async function deleteStudent(
  ...
  const parsed = studentDeleteSchema.safeParse(formData);
  ...
  if (parsed.data.cin !== parsed.data.confirm_cin) {
    return {
      message: "رقم بطاقة التعريف الذي أدخلته لا يطابق رقم الطالب",
    };
  }
